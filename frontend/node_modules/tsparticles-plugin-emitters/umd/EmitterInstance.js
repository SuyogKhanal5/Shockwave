...
(function (factory) {
    ...
    class EmitterInstance {
        ...
        emitParticles(quantity) {
            var _a, _b, _c;
            const position = this.getPosition(), size = this.getSize(), singleParticlesOptions = this.particlesOptions instanceof Array ? (0, tsparticles_engine_1.itemFromArray)(this.particlesOptions) : this.particlesOptions;
