    ...
    class TextDrawer {
        draw(context, particle, radius, opacity) {
            ...
            if (textParticle.text === undefined) {
                textParticle.text =
                    textData instanceof Array ? (0, tsparticles_engine_1.itemFromArray)(textData, particle.randomIndexData) : textData;
            }
            ...
            if (exports.validTypes.find((t) => (0, tsparticles_engine_1.isInArray)(t, options.particles.shape.type))) {
                ...
                if (shapeOptions instanceof Array) {
                    ...
                    for (const character of shapeOptions) {
                        ...
                        promises.push((0, tsparticles_engine_1.loadFont)(charShape.font, charShape.weight));
                    }
                    ...
                    if (shapeOptions !== undefined) {
                        ...
                        await (0, tsparticles_engine_1.loadFont)(charShape.font, charShape.weight);
                    }
                }
            }
        }
