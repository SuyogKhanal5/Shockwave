    ...
    class Collider extends tsparticles_engine_1.ParticlesInteractorBase {
        ...
        async interact(p1) {
            ...
            for (const p2 of query) {
                ...
                const dist = (0, tsparticles_engine_1.getDistance)(pos1, pos2);
                const distP = radius1 + radius2;
                if (dist > distP) {
                    continue;
                }
                (0, ResolveCollision_1.resolveCollision)(p1, p2, container.fpsLimit / 1000, container.retina.pixelRatio);
            }
        }
        isEnabled(particle) {
